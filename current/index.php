	...
	>
		...
		<?php if ($is_logged_in): ?>
			<div class="flex flex-1 relative overflow-hidden">
				...
				<aside id="sidebar" class="absolute top-0 bottom-0 left-0 w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col z-40
                                      transform -translate-x-full transition-transform md:relative md:translate-x-0">
					<!-- Main sidebar content that grows to fill space -->
					...
					<!-- Storage info pinned to the bottom of the sidebar -->
				...
				<div class="flex-1 flex flex-col overflow-hidden">
					...
					<main id="main-content" class="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto">
						...
						<div id="grid-view" class="hidden"><div id="file-grid-container" class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7 2xl:grid-cols-8 gap-4"></div></div>
